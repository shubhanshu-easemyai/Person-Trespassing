...
class KafkaConsumerHandler:
    ...
    def consume_from_source(self, buffer_id: str = None):
        consumer = self.create_consumer()
        source_buffer_details = encryption_handler.decrypt(buffer_id)

        partition = TopicPartition(
            source_buffer_details["topic"],
            source_buffer_details["partition"],
            source_buffer_details["offset"],
        )
        ...
        while True:
            ...
            print(message.offset(),source_buffer_details["offset"])
            transaction_data = {
